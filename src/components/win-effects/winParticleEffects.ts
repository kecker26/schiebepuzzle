...
const PRESETS: Record<StaticTagCategoryId | 'neutral', WinParticlePreset> = {
  ...
  activities: preset('activities', 'Aktivitäten & Sport', ['trophy', 'activity', 'sparkles'], 'burst', ['#fbbf24', '#fb7185', '#60a5fa'], 24),
  ...
  materials: preset('materials', 'Materialien & Oberflächen', ['gem', 'shapes'], 'burst', ['#d6d3d1', '#94a3b8', '#a5f3fc'], 20),
