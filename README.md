...
- Konfigurierbare Heatmap mit klassischen Entfernungs-Farbflaechen, Richtungspfeilen oder Fortschrittsvergleich der letzten fuenf Zuege, optionalen kompakten X-/Y-Zielabweichungen, Intensitaetsregler und kompakter Legende direkt am Puzzlebrett. Die X-/Y-Anzeige aktiviert automatisch Farbflaechen; Pfeile oder Verlauf blenden sie wieder aus. Dabei zeigt `X+` nach rechts und `Y+` nach oben.
