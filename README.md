...
- Galerie geloester Motive inklusive bildspezifischer Paletten fuer Galerie-, Spielstand-, Sammlungs- und Detailkarten, die dem zentralen Palette-Schalter folgen, Wiedereinstieg mit gespeicherter Stufe, gespeichertem Originalzuschnitt, transparentem Challenge-Startdialog mit Medaillen-Regeln, clean-only Medaillen-Vorlagen, Uebungs-Replay fuer assistierte Startzustaende, neutralen Startzustand-Serien fuer Laeufe mit gleichem Startbrett ohne Medaillenbezug, cleanem Vorlagenanker, einklappbaren assistierten Uebungslaeufen und verwandten Startzustandslaeufen direkt an der passenden Challenge-Serie, Anzeige der besten noch erreichbaren Medaille fuer Zeit, Netto-Zuege und Hilfe-Status, dauerhaften Bronze-, Silber-, Gold- und Diamant-Medaillen, medaillenlosen Challenge-Abschluessen ohne uebertroffene Vorlage, motivweit deduplizierter Medaillen-Sammlung mit klickbaren Filtern, Medaillen-Jagd nach fehlenden oder nahen Upgrades, konkreten Jagd-Zielen und Naehe-Einschaetzungen pro Motiv, Sortierung nach Upgrade-Potenzial und kompaktem Medaillen-Fortschritt pro Galeriekarte, mathematisch korrektem Ueberspringen von Gold bei bereits optimalen Vorlagen, konkretem Hinweis auf die naechste Medaillenstufe im Gewinn-Dialog, farbcodierten Challenge-Serien mit genau einer Vorlage, chronologischer Medaillen-Entwicklung, allen direkten Versuchen, sichtbaren Folgebeziehungen und Vorschauen des tatsaechlich gemischten Startbretts sowie einem getrennten Bereich fuer eigenstaendige Laeufe mit groesserer Startbrett-Vorschau, 9er-Seitennavigation, optionalem KI-Tagging, vollstaendiger Tag-Anzeige auf Galeriekarten, Retry fuer fehlgeschlagene Tags, manuellen Tags im Detaildialog und als Tag-Manager-Batch, dauerhaft ausgeblendeten abgelehnten KI-Tags, gemeinsamer lokaler Tag-Taxonomie, ungeordneten unbekannten Tags, persistierten manuellen und KI-gelernten Kategoriezuordnungen sowie bestaetigungspflichtigen KI-Vorschlaegen fuer eigene Kategorien, klickbaren Tag-Filtern und kontextuellen Multi-Tag-Chips mit UND-Verknuepfung, Tag-Bildersuche fuer Online-Provider mit direktem Crop-Flow, aehnlichen Motiven nach Tag-Ueberschneidung und kategorisierter Tag-Verwaltung mit Mehrfachauswahl.
...
4. Puzzle spielen, Hinweise, Geisteransicht, Heatmap oder Solver-Unterstuetzung nutzen; bei einem Challenge-Start zeigt das linke Panel den laufenden Vergleich mit Zeit- und Netto-Zugziel. Ghost- und Heatmap-Nutzung werden separat erfasst und zaehlen wie andere Hilfen gegen Clean-Laeufe sowie Gold- und Diamant-Challenges.
5. Nach dem Loesen Statistik, Bestwerte und Galerie aktualisieren lassen; Challenge-Laeufe erhalten Bronze beim strikten Unterbieten mindestens eines Ziels, Silber beim Erreichen beider Ziele und anhand von Clean-Status sowie exaktem Solver-Optimum Gold oder Diamant. Ohne uebertroffenen Zielwert bleibt der Lauf medaillenlos.
...
- Challenge-Laeufe speichern ihr aktives Ziel im Spielstand sowie `challengeTargetId` und optional `challengeMedal` im Galerieeintrag; medaillenlose neue Laeufe lassen `challengeMedal` weg, bestehende Medaillen werden nicht neu bewertet, und fehlende oder geloeschte Vorlagen duerfen historische Medaillen nicht unlesbar machen. Neue Medaillen-Vorlagen muessen ein cleanes Detailprofil haben; assistierte Startzustaende bleiben als Uebung replaybar und werden im Detaildialog per Startbrett-Fingerprint als neutrale Startzustand-Serie gruppiert. Sobald eine cleane Vorlage in so einer Serie existiert, steht sie oben als Medaillen-Vorlage; assistierte Uebungslaeufe werden nur visuell einklappbar, nicht automatisch geloescht. Startzustandslaeufe, die dasselbe Startbrett wie eine Challenge-Vorlage teilen und selbst keine Challenge-Vorlage oder kein Challenge-Versuch sind, werden als verwandte Laeufe in der Challenge-Serie angezeigt, ohne die Medaillenwertung zu beeinflussen.
