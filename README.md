...
- Statistik mit drei visuellen Hauptansichten fuer Dashboard, Verlauf & Trends sowie Rohdaten & Details, Einzellauf-Tabelle mit 25er-Seitennavigation; Recharts visualisiert Laufarten und die beste Challenge-Medaille pro Motiv als Donut-Charts sowie interaktive Laufverlaeufe und gestapelte Verteilungen fuer Aktionen oder Zeit. Verlauf und Verteilung besitzen jeweils eigene Metrik- und Zeitraumsteuerungen, eine eigene Schwierigkeitsfarblegende und einen Sprung zum Seitenanfang. Die Verteilung nutzt 15-Sekunden-Intervalle im dichtesten Laufzeitbereich beziehungsweise automatisch passende runde Aktionsintervalle; nach aussen werden die Intervalle zunehmend groesser, leere Bereiche eng verdichtet und Balkenabstaende bei vielen Intervallen automatisch verkleinert. Die Trendansicht bietet einen optionalen gleitenden 5er-Durchschnitt je Schwierigkeitsstufe, ruhige Rohdatenpunkte, fokussierbare Schwierigkeitsreihen, eine motivweit deduplizierte Medaillen-Aufstiegs-Timeline und kollisionsfrei zusammengefuehrte Bestwert-/Median-Referenzen; Rohdaten-Tabellen greifen dieselben Schwierigkeitsfarben auf, waehrend CSV-/JSON-Exporte direkt im Projektordner landen.
- Galerie geloester Motive inklusive bildspezifischer Paletten fuer Galerie-, Spielstand-, Sammlungs- und Detailkarten, die dem zentralen Palette-Schalter folgen, Wiedereinstieg mit gespeicherter Stufe, gespeichertem Originalzuschnitt, transparentem Challenge-Startdialog mit Medaillen-Regeln, Anzeige der besten noch erreichbaren Medaille fuer Zeit, Netto-Zuege und Hilfe-Status, dauerhaften Bronze-, Silber-, Gold- und Diamant-Medaillen, motivweit deduplizierter Medaillen-Sammlung mit klickbaren Filtern, Medaillen-Jagd nach fehlenden oder nahen Upgrades, konkreten Jagd-Zielen und Naehe-Einschaetzungen pro Motiv, Sortierung nach Upgrade-Potenzial und kompaktem Medaillen-Fortschritt pro Galeriekarte, mathematisch korrektem Ueberspringen von Gold bei bereits optimalen Vorlagen, konkretem Hinweis auf die naechste Medaillenstufe im Gewinn-Dialog, farbcodierten Challenge-Serien mit genau einer Vorlage, chronologischer Medaillen-Entwicklung, allen direkten Versuchen, sichtbaren Folgebeziehungen und Vorschauen des tatsaechlich gemischten Startbretts sowie einem getrennten Bereich fuer eigenstaendige Laeufe mit groesserer Startbrett-Vorschau, 9er-Seitennavigation, optionalem KI-Tagging, vollstaendiger Tag-Anzeige auf Galeriekarten, Retry fuer fehlgeschlagene Tags, manuellen Tags im Detaildialog und als Tag-Manager-Batch, dauerhaft ausgeblendeten abgelehnten KI-Tags, gemeinsamer lokaler Tag-Taxonomie, ungeordneten unbekannten Tags, persistierten manuellen und KI-gelernten Kategoriezuordnungen sowie bestaetigungspflichtigen KI-Vorschlaegen fuer eigene Kategorien, klickbaren Tag-Filtern und kontextuellen Multi-Tag-Chips mit UND-Verknuepfung, Tag-Bildersuche fuer Online-Provider mit direktem Crop-Flow, aehnlichen Motiven nach Tag-Ueberschneidung und kategorisierter Tag-Verwaltung mit Mehrfachauswahl.
...
4. Puzzle spielen, Hinweise nutzen oder Solver-Unterstuetzung anfordern; bei einem Challenge-Start zeigt das linke Panel den laufenden Vergleich mit Zeit- und Netto-Zugziel.
5. Nach dem Loesen Statistik, Bestwerte und Galerie aktualisieren lassen; Challenge-Laeufe erhalten anhand von Clean-Status, unterbotenen Zielen und exaktem Solver-Optimum eine dauerhafte Medaille.
...
- Challenge-Laeufe speichern ihr aktives Ziel im Spielstand sowie `challengeTargetId` und `challengeMedal` im Galerieeintrag; fehlende oder geloeschte Vorlagen duerfen historische Medaillen nicht unlesbar machen.
