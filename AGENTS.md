...
- Challenge-Serienkarten im Galerie-Detail sind ueber `AnimatedCollapse` einzeln einklappbar; ihre zugehoerigen Versuche stehen nach Bestwert sortiert, waehrend die Medaillen-Entwicklung chronologisch bleibt. Geschaetzte Ursprungserien zeigen den Bereich "Vor dem echten Ziel", die echte Vorlage und danach echte Medaillenversuche getrennt.
